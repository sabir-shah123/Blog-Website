@php
    $breadcrumb = [['name' => 'Dashboard', 'url' => route('backend.dashboard')], ['name' => 'Settings', 'url' => '#']];
    $user = auth()->user();
@endphp
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        novalidate="novalidate" method="POST" action="{{ route('backend.profile.save') }}"
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                                ...
                                <form id="kt_signin_change_email" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                                    novalidate="novalidate" method="POST" action="{{ route('backend.email.save') }}">
                                    @csrf
                                    <div class="row mb-6">
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-10">
                            ...
                            <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                                ...
                                <form id="kt_signin_change_password"
                                    ...
                                    method="POST" action="{{ route('backend.password.save') }}">
                                    @csrf
                                    <div class="row mb-1">
                                        <div class="col-lg-4">
                                            <div class="fv-row mb-0 fv-plugins-icon-container">
