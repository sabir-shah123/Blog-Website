                        ...
                        <div class="col-12 mb-4">
                            <article class="card article-card">
                                ...
                                <div class="card-body px-0 pb-1">
                                    ...
                                    <h2 class="h1"><a class="post-title" href="article.html">Is it Ethical to Travel
                                            Now?
                                    ...
                                    <p class="card-text">Heading Here is example of hedings. You can use this heading by
                                        following markdownify rules. For example: use # for heading 1 and use ###### for
                                        heading 6.</p>
                            ...
                            <article class="card article-card article-card-sm h-100">
                                <a href="article.html">
                                    <div class="card-image">
                                        ...
                                        <img loading="lazy" decoding="async" src="images/post/cr-2.jpg"
                                            alt="Post Thumbnail" class="w-100">
                                    </div>
                                </a>
                                <div class="card-body px-0 pb-0">
                                    ...
                                    <p class="card-text">Heading Here is example of hedings. You can use this heading
                                        by following markdownify rules. For example: use # for …</p>
                                    <div class="content"> <a class="read-more-btn" href="article.html">Read Full
                                            Article</a>
                                    </div>
                                </div>
                            ...
                            <article class="card article-card article-card-sm h-100">
                                <a href="article.html">
                                    <div class="card-image">
                                        ...
                                        <img loading="lazy" decoding="async" src="images/post/post-4.jpg"
                                            alt="Post Thumbnail" class="w-100">
                                    </div>
                                </a>
                                <div class="card-body px-0 pb-0">
